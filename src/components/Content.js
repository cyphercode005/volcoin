...
export default function Content() {
  ...
  {Array.from({ length: 4 }, (_, index) => ( 
    <div
      key={index}
      className={`relative pl-6 lg:pl-0 lg:pr-12 2xl:pr-20 ${
        index < 3 ? 'border-l-2 lg:border-l-0' : ''
      } ${index < 3 ? 'lg:border-t-2' : ''} text-white text-lg pr-8 pb-6 lg:pb-0 lg:pt-6 2xl:pt-8`}
    >     
        <img className='absolute -left-3 lg:left-0 lg:-top-2 2xl:-top-3 lg:h-4 2xl:h-5' src="/Photos/contentEllipse.png" alt="" />
