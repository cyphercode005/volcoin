            ...
            <div className="flex lg:items-center justify-between">
                ...
                <ul className="flex flex-col lg:flex-row flex-wrap text-sm lg:text-sm xl:text-sm 2xl:text-xl xxl:text-2xl text-color lg:items-center">
                    <li className='flex justify-end mr-2 xl:mr-3 xxl:mr-4 my-1 lg:my-0'>
                        <img className='h-5 2xl:h-7 xxl:h-8 px-2' src="/SVGs/UnionThree.svg" alt="" /><a href="/" className="">WHITEPAPER</a>
                    </li>
                    <li className='flex justify-end mr-2 lg:mr-3 xxl:mr-4 my-1 lg:my-0'>
                        <img className='h-5 2xl:h-7 xxl:h-8 px-2' src="/SVGs/UnionThree.svg" alt="" /><a href="/" className="">EMAIL US</a>
                    </li>
                    <li className='flex justify-end mr-2 xl:mr-3 xxl:mr-4 my-1 lg:my-0'>
                        <img className='h-5 2xl:h-7 xxl:h-8 px-2' src="/SVGs/UnionThree.svg" alt="" /><a href="/" className="">TWITTER</a>
                    </li>
                    <li className='flex justify-end mr-2 xl:mr-3 xxl:mr-4 my-1 lg:my-0'>
                        <img className='h-5 2xl:h-7 xxl:h-8 px-2' src="/SVGs/UnionThree.svg" alt="" /><a href="/" className="">PRIVACY</a>
                    </li>
                    <li className='flex justify-end mr-2 xl:mr-3 xxl:mr-4 my-1 lg:my-0'>
                        <img className='h-5 2xl:h-7 xxl:h-8 px-2' src="/SVGs/UnionThree.svg" alt="" /><a href="/" className="">T & C</a>
                    </li>
                    <li>
