...
<footer className="pl-4 lg:pl-12 xl:pl-12 pr-4 lg:pr-12 xl:pr-12  bg-gray-900 mt-5 pt-4 lg:pt-6 xl:pt-6 lg:mt-16 xl:mt-16 pb-4 lg:pb-8 xl:pb-8 shadow bg-black">
