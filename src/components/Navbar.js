  ...
  return (
    <nav className='flex flex-1 justify-between pt-5 2xl:pt-9 xxl:pt-10 mx-1'>
      <section className='flex flex-1 px-2 lg:px-12 xl:px-12 2xl:px-12 xxl:px-12'>
        ...
        <span className='invisible lg:visible xl:visible 2xl:visible xxl:visible text-white  text-xs lg:text-sm xl:text-sm 2xl:text-lg xxl:text-2xl'>VOLCOIN</span>
      </section>  
      <section className='flex flex-none lg:flex-none xl:flex-none 2xl:flex-none xxl:flex-none pr-4 lg:pr-16 xl:pr-16'>
        <button className='hidden lg:block xl:block 2xl:block xxl:block rounded text-gray-400 px-3 mx-0 lg:mx-2 xl:mx-2 text-xs lg:text-sm xl:text-sm 2xl:text-xl xxl:text-2xl' onClick={handleOpenModal}> WHITEPAPER </button>
        <button className='border border-gray-400 rounded mx-0 lg:mx-2 xl:mx-2 px-1 lg:px-2 xl:px-3  text-gray-400 text-xs lg:text-sm xl:text-sm 2xl:text-xl xxl:text-2xl'> PURCHASE VOLCOIN </button>
      </section>
      {showModal && (
