          ...
          {styles.map((i) => (
            <div key={i} className={`${i}`}>
              <div className="scrolling-text inline-block  will-change-transform  backface-invisible">
                <span className="volmed h-8 scrolling-text-content whitespace-nowrap leading-none space-x-4">
                  ...
                  <span class="inline-block align-middle mb-4">
                    <svg className="top-1/2 transform -translate-y-1/2 h-16" width="136" height="76" viewBox="0 0 136 76" fill="none" xmlns="http://www.w3.org/2000/svg">
