    ...
    <div className="mt-12 lg:mt-16 xl:mt-16 pb-10 pl-10 lg:pl-16 xl:pl-16">
      ...
      <div className="mt-10">
        <div className="flex flex-col lg:flex-row xl:flex-row">
          <button className="mr-20 lg:mr-0 xl:mr-0 text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 shadow-md shadow-lime-500/50 dark:shadow-lg dark:shadow-lime-800/80 font-medium rounded-lg text-sm px-5 py-2 text-center">
            PURCHASE VOLCOIN →
          </button>
          <button onClick={handleDownload} type="button" class="mr-20 lg:mr-0 xl:mr-0 text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 shadow-md shadow-lime-500/50 dark:shadow-lg dark:shadow-lime-800/80 font-medium rounded-lg text-sm px-5 py-2 text-center ml-2 lg:ml-10 xl:ml-10 mt-2 lg:mt-0 xl:mt-0 ">DOWNLOAD</button>
