...
export default function RoadMap() {
  const content = {
    "one": <>
      <span className="text-md text-yellow-200"> Q2 2022 </span>
      ...
      <section className="mt-4 lg:mt-7 xl:mt-7">
        <div className="flex text-justify pr-4 lg:pr-16 xl:pr-16">
          <img className="w-3 lg:w-3 xl:w-3 2xl:w-5 xxl:w-5 h-3 lg:h-3 xl:h-3 2xl:h-5 xxl:h-5 mt-1 lg:mt-1 xl:mt-1 2xl:mt-2 xxl:mt-2 mr-2" src="/Photos/tickRoadMap.png" alt="" />
          <p className="text-xs lg:text-sm xl:text-sm 2xl:text-xl xxl:text-xl">
    ...
    "two": <>
      <span className="text-md text-yellow-200"> Q3 2022 </span>
      <h1 className=" pt-3 text-xl lg:text-3xl xl:text-3xl 2xl:text-4xl xxl:text-4xl lg:w-1/2 xl:w-1/2">
        Form the team          </h1>
      <section className="mt-4 lg:mt-7 xl:mt-7">
        <div className="flex text-justify pr-4 lg:pr-16 xl:pr-16">
    ...
    "three": <>
      <span className="text-md text-yellow-200"> Q1 2023 </span>
      <h1 className=" pt-3 text-xl lg:text-3xl xl:text-3xl 2xl:text-4xl xxl:text-4xl lg:w-1/2 xl:w-1/2">
        Create GVolCoins and Marketing
      </h1>
      <section className="mt-4 lg:mt-7 xl:mt-7">
        <div className="flex pr-4 lg:pr-16 xl:pr-16">
          <img className="w-3 lg:w-3 xl:w-3 2xl:w-5 xxl:w-5 h-3 lg:h-3 xl:h-3 2xl:h-5 xxl:h-5 mt-1 lg:mt-1 xl:mt-1 2xl:mt-2 xxl:mt-2 mr-2" src="/Photos/tickRoadMap.png" alt="" />
          <p className="text-xs lg:text-sm xl:text-sm 2xl:text-xl xxl:text-xl">
    ...
    "five": <>
      <span className="text-md text-yellow-200"> Q2 2023 </span>
    ...
    "seven": <>
      <span className="text-md text-yellow-200"> Q3 2024 </span>
      <h1 className=" pt-3 text-xl lg:text-3xl xl:text-3xl 2xl:text-4xl xxl:text-4xl lg:w-1/2 xl:w-1/2">
        Staking          </h1>
      <section className="mt-4 lg:mt-7 xl:mt-7">
        <div className="flex text-justify pr-4 lg:pr-16 xl:pr-16">
    ...
    "eight": <>
      <span className="text-md text-yellow-200"> Q4 2024 </span>
      <h1 className=" pt-3 text-xl lg:text-3xl xl:text-3xl 2xl:text-4xl xxl:text-4xl lg:w-1/2 xl:w-1/2">
        Onward          </h1>
      <section className="mt-4 lg:mt-7 xl:mt-7">
        <div className="flex text-justify pr-4 lg:pr-16 xl:pr-16">
    ...
    "nine": <>
      <span className="text-md text-yellow-200"></span>
